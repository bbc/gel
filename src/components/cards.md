...
If (as illustrated in the [original GEL Card documentation](https://www.bbc.co.uk/gel/guidelines/cards)) an auxiliary play/pause button is provided,  ensure that the button is accessible. See [Video controls](../video-controls) for more information.
